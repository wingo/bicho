...
(define (invert-partition map)
  "Assuming the values of @var{map} are intsets and the values they
contain are unique, compute a map in which each member of each set maps
to its key.  If the values are not unique, an error will be signalled."
